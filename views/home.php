        ...
        <div class="row">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        <div class="carousel-item active" >
                            <img class="img-fluid" src="https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:quality(60)/H1_1440x242_a66581f61b.png" alt="Image" style="height: calc(100vh / 2.56666)">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:quality(60)/H1_1440x242_4_97af1daadc.png" alt="Image" style="height: calc(100vh / 2.56666)">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:quality(60)/H1_1440x242_1_293a43720e.png" alt="Image" style="height: calc(100vh / 2.56666)">
            ...
            <div class="col-lg-4">
                <div class="product-offer" >
                    <img class="img-fluid" src="public/img/banner/a.jpg" alt="">
                    
                </div>
                <div class="product-offer">
                    <img class="img-fluid" src="public/img/banner/b.jpg" alt="">
    ...
    <section class="container cate-home" style="background-color: #ffffff; border-radius: 10px;">    
        ...
        <div class="row g-1 mb-4 mt-2 pb-4">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 text-center p-1 cate-gory">
                <a href="<?=$link?>"><img style="width: 50%;" src="upload/dienthoai.png" alt=""></a>
                <div class="mt-2">
